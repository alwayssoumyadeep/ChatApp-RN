...
export default function ProfileScreen({ navigation }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Normalize to same shape as login/register: { id, username, email, about, profilePicture }
  ...
  if (loading) {
    return (
      <SafeAreaView className="flex-1 bg-white items-center justify-center" style={{ paddingTop: StatusBar.currentHeight || 0 }}>
